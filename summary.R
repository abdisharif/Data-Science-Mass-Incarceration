...
race_with_the_highest_crime_rate_in_2019 <- select(Data_2019, White,Black.or.African.American,American.Indian.or.Alaska.Native,Asian,Native.Hawaiian.or.Other.Pacific.Islander)
